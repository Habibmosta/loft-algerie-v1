...
export const translations = {
  en: {
    ...
    transactions: {
      ...
      enterTransactionInfo: "Enter the transaction information below",
    ...
    tasks: {
      ...
      fillTaskInformation: "Fill in the task information below",
      memberCanOnlyUpdateStatus: "Members can only update the task status",
    ...
    settings: {
      ...
      dueDateRemindersDesc: "Receive reminders for upcoming due dates",
      financialReports: "Financial Reports",
      financialReportsDesc: "Get notified about financial report updates",
      enable: "Enable",
      dataPrivacy: "Data & Privacy",
      manageDataPrivacy: "Manage your data and privacy settings",
      dataExport: "Data Export",
      dataExportDesc: "Export all your personal data",
      exportData: "Export Data",
      accountDeletion: "Account Deletion",
      accountDeletionDesc: "Permanently delete your account and all data",
  ...
  fr: {
    ...
    transactions: {
      ...
      enterTransactionInfo: "Saisissez les informations de la transaction ci-dessous",
      description: "Description",
      date: "Date",
      status: "Statut",
      optional: "Optionnel",
    ...
    tasks: {
      ...
      fillTaskInformation: "Remplissez les informations de la tâche ci-dessous",
      memberCanOnlyUpdateStatus: "Les membres ne peuvent que mettre à jour le statut de la tâche",
    ...
    analytics: {
      ...
      subtitle: "Analyses financières complètes et insights",
      top5ProfitableLofts: "Top 5 des Lofts les Plus Rentables",
      ...
      trackRevenueExpenses: "Suivre les revenus et dépenses dans le temps",
      expenses: "Dépenses",
      revenue: "Revenus"
    },
    ...
    settings: {
      ...
      taskAssignmentsDesc: "Être notifié quand des tâches vous sont assignées",
      dueDateReminders: "Rappels d'Échéance",
      dueDateRemindersDesc: "Recevoir des rappels pour les échéances à venir",
      financialReports: "Rapports Financiers",
      financialReportsDesc: "Être notifié des mises à jour des rapports financiers",
      enable: "Activer",
      dataPrivacy: "Données et Confidentialité",
      manageDataPrivacy: "Gérez vos paramètres de données et confidentialité",
      dataExport: "Export de Données",
      dataExportDesc: "Exportez toutes vos données personnelles",
      exportData: "Exporter les Données",
      accountDeletion: "Suppression de Compte",
      accountDeletionDesc: "Supprimer définitivement votre compte et toutes les données",
  ...
  ar: {
    ...
    transactions: {
      ...
      enterTransactionInfo: "أدخل معلومات المعاملة أدناه",
      description: "الوصف",
      date: "التاريخ",
      status: "الحالة",
      optional: "اختياري",
    ...
    tasks: {
      ...
      fillTaskInformation: "املأ معلومات المهمة أدناه",
      memberCanOnlyUpdateStatus: "يمكن للأعضاء تحديث حالة المهمة فقط",
    ...
    analytics: {
      ...
      subtitle: "تحليلات مالية شاملة ورؤى",
      top5ProfitableLofts: "أفضل 5 لوفتات ربحية",
      ...
      revenueExpensesByLoft: "الإيرادات والمصروفات حسب اللوفت",
      detailedFinancialPerformance: "الأداء المالي المفصل",
      monthlyFinancialTrend: "الاتجاه المالي الشهري",
      trackRevenueExpenses: "تتبع الإيرادات والمصروفات عبر الزمن",
      expenses: "المصروفات",
      revenue: "الإيرادات"
    },
    ...
    internetConnections: {
      ...
      create: "إنشاء",
      noConnectionTypesFound: "لم يتم العثور على أنواع اتصالات إنترنت.",
      editConnectionType: "تعديل نوع الاتصال",
      updateConnectionInfo: "تحديث معلومات نوع الاتصال",
      createNewConnectionType: "إنشاء نوع اتصال إنترنت جديد",
      connectionDetails: "تفاصيل الاتصال",
      enterConnectionInfo: "أدخل معلومات الاتصال أدناه"
    },
    ...
    settings: {
      ...
      notifications: "الإشعارات",
      configureNotifications: "تكوين تفضيلات الإشعارات",
      taskAssignments: "تعيين المهام",
      taskAssignmentsDesc: "احصل على إشعار عند تعيين مهام لك",
      dueDateReminders: "تذكيرات تاريخ الاستحقاق",
      dueDateRemindersDesc: "تلقي تذكيرات للمواعيد النهائية القادمة",
      financialReports: "التقارير المالية",
      financialReportsDesc: "احصل على إشعار حول تحديثات التقارير المالية",
      enable: "تفعيل",
      dataPrivacy: "البيانات والخصوصية",
      manageDataPrivacy: "إدارة إعدادات البيانات والخصوصية",
      dataExport: "تصدير البيانات",
      dataExportDesc: "تصدير جميع بياناتك الشخصية",
      exportData: "تصدير البيانات",
      accountDeletion: "حذف الحساب",
      accountDeletionDesc: "حذف حسابك وجميع البيانات نهائياً",
