...
export const translations = {
  en: {
    ...
    lofts: {
      ...
      noLoftsMatch: "No lofts match your filters",
  ...
  fr: {
    ...
    lofts: {
      ...
      noLoftsMatch: "Aucun loft ne correspond à vos filtres",
  ...
  ar: {
    ...
    lofts: {
      ...
      noLoftsMatch: "لا توجد لوفت تطابق المرشحات",
    ...
    dashboard: {
      title: "لوحة التحكم",
      subtitle: "مرحباً بك في لوحة تحكم إدارة العقارات",
      welcomeBack: "مرحباً بعودتك",
      totalLofts: "إجمالي اللوفت",
      occupiedLofts: "اللوفت المشغولة",
      ...
      updated: "محدث",
      overdue: "متأخر",
      billsPastDue: "الفواتير المتأخرة",
      dueToday: "مستحق اليوم",
      billsDueNow: "الفواتير المستحقة الآن",
      upcoming: "قادم",
      next30Days: "الـ 30 يوماً القادمة",
      active: "نشط",
      loftsWithBills: "اللوفت مع الفواتير",
      systemStatus: "حالة النظام",
      allBillsCurrent: "جميع الفواتير محدثة",
